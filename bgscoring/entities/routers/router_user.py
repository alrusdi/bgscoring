...
from bgscoring.entities.crud.crud_user import (
    create_new_user,
    delete_user,
    read_user_by_email,
    read_user_by_id,
...
from bgscoring.entities.schemas.schemas_user import (
    UserCreate,
    UserDelete,
    UserShow,
    UserUpdate,
...
async def create_user(body: UserCreate, db: AsyncSession = Depends(get_async_session)):
    """..."""
    try:
